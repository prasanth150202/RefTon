...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="../../pretrained_models/FLUX.1-Kontext-dev",
        required=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Flag to use reference person image data.",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Flag to use unpair person when inference.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Dropout probability for reference conditions",
    )
    parser.add_argument(
        "--lora_dropout",
        type=float,
    ...
    parser.add_argument(
        ...
        default="desc.json",
        required=False,
        help="Path to the prompts for Qwen2.5-VL when generating reference images",
    )
    parser.add_argument(
    ...
    if args.cond_image_column is not None:
        ...
        if args.validation_prompt is not None:
            assert args.validation_image is None and os.path.exists(
